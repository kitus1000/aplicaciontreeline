    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-zinc-200 pb-6">
                <div>
                    ...
                    <p className="text-zinc-500 mt-1">
                        Gestión ejecutiva de solicitudes y jornadas de personal.
                    </p>
                </div>
                ...
                <div className="flex gap-4">
                    <Link 
                        ...
                        className="bg-indigo-600 text-white px-6 py-2.5 rounded-xl text-sm font-black uppercase tracking-widest hover:bg-black transition-all shadow-lg shadow-indigo-100 flex items-center gap-2"
                    >
            ...
            <div className="flex flex-col sm:flex-row gap-3 items-end sm:items-center justify-between">
                <h2 className="text-xl font-bold text-zinc-800">Solicitudes Administrativas (Vacaciones, Permisos, etc)</h2>
